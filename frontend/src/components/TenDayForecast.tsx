        ...
        {days.length > 0 ? (
          days.map((day, index) => {
            ...
            return (
              <li
                key={day.date}
                className="grid grid-cols-[3.5rem_1.25rem_2.5rem_minmax(2rem,1fr)_2.5rem] items-center gap-2 px-3 py-3 text-sm sm:grid-cols-[5rem_2rem_3rem_1fr_3rem] sm:gap-3 sm:px-4"
              >
